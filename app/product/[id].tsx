...
import { getProductById } from '../../services/storage/products';
      ...
      >
        ...
        <Section palette={palette} title={t('import.fieldInventory')}>
          <View style={[styles.inventoryBanner, { backgroundColor: p.card, borderColor: p.border }]}>
            <Text style={[styles.inventoryText, { color: p.text }]}>{inventoryLabel(product.inventory)}</Text>
          </View>
        </Section>
      </ScrollView>
    </View>
